  ...
  <ul class="nav container nav-pills nav-fill">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu text-center" style="min-width: 380px">
        <router-link class="dropdown-item" to="/test_bootstrap"
          >通勤出行</router-link
        >
    ...
    <li class="nav-item dropdown">
      ...
      >
      <div class="dropdown-menu text-center" style="min-width: 380px">
        <router-link class="dropdown-item" to="/cv_origin"
          >车联网示范区</router-link
        >
        <div class="dropdown-divider"></div>
        <router-link class="dropdown-item" to="/test_bootstrap"
...
<script>
import cvright from "./cvright.vue";
import cvcenter from "./cvcenter.vue";
