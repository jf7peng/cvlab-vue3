<template>
    <div class="visual_box1">
				<div class="visual_title">
					<span>高速线路出行量变化趋势</span>
					<img src="../assets/ksh33.png">
				</div>
				<div class="visual_chart1" id="main3">
       ...
       name:'拥堵指数',
        ...
        areaStyle: {
            normal: {
                ...
                shadowColor: 'rgb(31,83,128,0.8)',
                shadowBlur: 10
            }
        },
        itemStyle: {
            normal: {
                color: 'rgb(63,194,187)'
            }
        },
        data: 
        [3,6,3,5,4,10,14,16,
            18,24,30,35,23,22,21,23,
            18,14,15,16,6,5,6,4,2
    ]
    }  ]
    });
 }
