...
div.first_03 .news-hot {
  float: left;
  width: 480px;
  margin-left: 0px;
  height: auto;
}
div.first_03 .news-hot .tuij_news {
  height: auto;
}

div.first_03 .news-hot .content {
  padding: 0 0 0 0 px;
  line-height: 25px;
  text-align: center;
...
div.first_03 .news-hot .tuij_news li {
  line-height: 2em;
  list-style: none;
  padding-left: 0px;
}
